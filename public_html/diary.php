...
$myhost=(empty($_SERVER["HTTPS"])?"http://":"https://").$_SERVER["HTTP_HOST"];
$myurl="$myhost/diary.php?p=$p";
...
echo"<meta property='og:url' content='$myurl'/>";
echo"<title>$title</title>";
?>
      <link rel="stylesheet" href="css/diary.css" type="text/css">
      <link rel="stylesheet" href="css/nav.css" type="text/css">
      <link rel="stylesheet" href="css/thumb.css" type="text/css">
      <link rel="alternate" type="application/rss+xml" title="RSS 2.0" href="<?php echo$myhost;?>/rss.xml" />
...
echo'</div><aside>';
include(__DIR__.'/include/village.php');
include_once(__DIR__.'/include/subindex.php');
include(__DIR__.'/include/rss.php');
if ($comment) {include_once(__DIR__.'/include/comment.php');}
//フッター
